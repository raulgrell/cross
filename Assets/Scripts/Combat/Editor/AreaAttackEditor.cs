...
[CustomEditor(typeof(AreaAttack), true)]
public class AreaAttackEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (showFrames)
        {
            ...
            for (int x = -1; x < cols; x++)
            {
                ...
                {
                    var pos = new Vector2Int(x - attack.spread, attack.spread - y);
