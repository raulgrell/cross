...
namespace XNodeEditor
{
    ...
    public static class NodeEditorGUILayout
    {
            ...
            Action<ReorderableList> onCreation = null)
        {
            ...
            List<XNode.NodePort> instancePorts = node.InstancePorts.Where(x => isMatchingInstancePort(x.fieldName))
            ...
            if (list == null)
            {
                ...
                list = CreateReorderableList(fieldName, instancePorts, arrayData, type, serializedObject, io,
        ...
        private static ReorderableList CreateReorderableList(string fieldName, List<XNode.NodePort> instancePorts,
            ...
            Action<ReorderableList> onCreation)
        {
            ...
            list.onRemoveCallback =
                (ReorderableList rl) =>
                {
                    ...
                    instancePorts = node.InstancePorts.Where(x => isMatchingInstancePort(x.fieldName))
                        .OrderBy(x => x.fieldName).ToList();
