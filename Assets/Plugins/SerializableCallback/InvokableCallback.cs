...
public class InvokableCallback<T0, TReturn> : InvokableCallbackBase<TReturn>
{
    ...
    public InvokableCallback(object target, string methodName)
    {
        ...
        {
            func = (System.Func<T0, TReturn>) System.Delegate.CreateDelegate(typeof(System.Func<T0, TReturn>), target,
                methodName);
        }
    }
}
...
public class InvokableCallback<T0, T1, TReturn> : InvokableCallbackBase<TReturn>
{
    ...
    public InvokableCallback(object target, string methodName)
    {
        ...
        {
            func = (System.Func<T0, T1, TReturn>) System.Delegate.CreateDelegate(typeof(System.Func<T0, T1, TReturn>),
                target, methodName);
        }
    }
}
