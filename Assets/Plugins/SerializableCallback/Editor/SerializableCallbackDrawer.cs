...
public class SerializableCallbackDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (target != null)
        {
            ...
            Rect methodRect = new Rect(position.x, targetRect.max.y + EditorGUIUtility.standardVerticalSpacing,
            ...
            if (activeMethod != null && !dynamic)
            {
                ...
                Rect argRect = new Rect(position.x, methodRect.max.y + EditorGUIUtility.standardVerticalSpacing,
                    position.width, EditorGUIUtility.singleLineHeight);
        ...
        {
            Rect helpBoxRect = new Rect(position.x + 8, targetRect.max.y + EditorGUIUtility.standardVerticalSpacing,
    ...
    private Type[] GetArgTypes(SerializedProperty argProp)
    {
        ...
        {
            types[i] = Arg.RealType((Arg.ArgType) argProp.FindPropertyRelative("Array.data[" + i + "].argType")
                .enumValueIndex);
        }
